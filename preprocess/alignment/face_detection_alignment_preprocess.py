...
def chelearn_age_dataset_preprocess():
    ...
    save_path = "/media/yi/e7036176-287c-4b18-9609-9811b8e33769/ElasticNN/data/cropped_5_landmarks_aligned_ChaLearn_AGE_CVPR_16"
...
if __name__ == "__main__":
    print("preprocessing age, gender, emotion dataset, including face detection, face alignment")
