...
class MTL_ResNet_50_model_101(torch.nn.Module):
  def __init__(self, gen_classes= 2, smile_classes = 2, emo_classes = 7, age_classes = 101):
    super(MTL_ResNet_50_model_101, self).__init__()
