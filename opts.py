...
parser.add_argument('--model', type=str, default="Multi_loss_InceptionV3",
                    help="[Multi_loss_AlexNet, Multi_loss_MobileNet_V1, Multi_loss_VGG16_bn_model, "
                    "Multi_loss_DenseNet_121_model, Multi_loss_InceptionV3]")
...
parser.add_argument('--loss_weights', type=list, default = [0, 0, 0, 1],
                    help="[1,1,1], multi-loss on age estimation, [classification_loss, l1_regression_loss, "
                    "euclidean_regression_loss, gaussian_loss]")
...
parser.add_argument('--all_losses', type=list, default =["classification_loss", "l1_regression_loss",
                                                         "euclidean_regression_loss", "gaussian_loss"],
                    help="")
...
parser.add_argument('--store_folder', type=str, default=["", ""],
                    help="['store_folder_in_thinkstation','store_folder_in_Narvi']")

parser.add_argument('--debug', type=bool, default=True, help="[True, False]")
# parser.add_argument('--age_loss_type', type=str, default="5_age_cls_loss",
#                     help="[5_age_cls_loss, 10_age_cls_loss, 20_age_cls_loss]")
