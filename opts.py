...
parser.add_argument('--multitask_weight_type', type=int, default = 0, help="multitask learning weight type, 3 = [1,1,1]")
...
parser.add_argument('--model', type=str, default="pretrained_ResNet18")
